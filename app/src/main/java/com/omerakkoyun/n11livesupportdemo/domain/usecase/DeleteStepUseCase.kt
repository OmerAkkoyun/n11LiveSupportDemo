...
class DeleteStepUseCase @Inject constructor(private val repositoryImpl: IStepsRepository) {

    suspend operator fun invoke(stepItem: StepItem) =  repositoryImpl.delete(stepItem)
